...
const profile = {
    ...
    skills: [
        'React', 'NextJS', 'Tailwind', 'Zustand', 'Node',
        'Express', 'Git', 'Linux', 'Postman', 
        'MySQL', 'MongoDB', 'PostgreSQL', 'Docker',
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  “3rd-year undergraduate student at IIIT Ranchi with a passion for full-stack development, problem solving, and building impactful projects.”
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1I19gzMdTDCqZZd1Cy1MnkXBnyZp-jKhz/view?usp=sharing"
