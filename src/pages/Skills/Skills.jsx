  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "SQL",
          icon: <FaDatabase className="w-4 h-4 text-[#336791]" />,
        },
        {
          name: "REST APIs",
    ...
    },
    {
      ...
      skills: [
        { name: "C++", icon: <SiCplusplus className="w-4 h-4 text-[#00599C]" /> },
        {
          ...
          icon: <MdDataObject className="w-4 h-4 text-[#34D399]" />,
        },
        {
          name: "Algorithms",
          icon: <FaProjectDiagram className="w-4 h-4 text-[#F87171]" />,
        },
        {
          name: "Problem Solving",
          icon: <FaLightbulb className="w-4 h-4 text-[#FBBF24]" />,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Zustand", icon: <span className="w-4 h-4 text-yellow-500">🐻</span> },
        { 
          name: "Postman", 
